...
I am a seasoned **Senior Security Network Engineer** with over 10 years of experience in designing, securing, and optimizing enterprise networks. My focus is on **network defense, threat detection, and security automation**.
...
- ☁️ Cloud security knowledge: **AWS, Azure, GCP IAM & network hardening**
...
- **Outcome:** Reduced audit time by 40% and improved compliance accuracy.

### 2. **SIEM Log Correlation Engine**
- **Description:** Custom log parser for Splunk to correlate suspicious events across multiple sources.
...
- **Tech Stack:** Wireshark, Zeek, Python
